...
_lr_productions = [
  ...
  ('BLOCK -> TkOBlock DECLARE LIST_INSTRUCTIONS TkCBlock','BLOCK',4,'p_program','yacc.py',41),
  ('SUBPROGRAM -> BLOCK','SUBPROGRAM',1,'p_subprogram','yacc.py',50),
  ('SUBPROGRAM -> LIST_INSTRUCTIONS','SUBPROGRAM',1,'p_subprogram','yacc.py',51),
  ('DECLARE -> TkDeclare LIST_DECLARE','DECLARE',2,'p_declare','yacc.py',57),
  ('DECLARE -> <empty>','DECLARE',0,'p_declare','yacc.py',58),
  ('LIST_DECLARE -> VARIABLE_DECLARATION','LIST_DECLARE',1,'p_list_declare_base','yacc.py',67),
  ('LIST_DECLARE -> LIST_DECLARE TkSemicolon VARIABLE_DECLARATION','LIST_DECLARE',3,'p_list_declare','yacc.py',73),
  ('VARIABLE_DECLARATION -> TkId TkTwoPoints TYPE','VARIABLE_DECLARATION',3,'p_list_variables_declare_base','yacc.py',80),
  ('VARIABLE_DECLARATION -> TkId TkComma VARIABLE_DECLARATION','VARIABLE_DECLARATION',3,'p_list_variables_declare','yacc.py',86),
  ('TYPE -> TkInt','TYPE',1,'p_type_varible_declare','yacc.py',92),
  ('TYPE -> TkBool','TYPE',1,'p_type_varible_declare','yacc.py',93),
  ('TYPE -> ARRAY_DECLARATION','TYPE',1,'p_type_varible_declare','yacc.py',94),
  ('ARRAY_DECLARATION -> TkArray TkOBracket NUM TkSoForth NUM TkCBracket','ARRAY_DECLARATION',6,'p_array_declaration','yacc.py',100),
  ('NUM -> TkNum','NUM',1,'p_num_integer','yacc.py',106),
  ('NUM -> TkMinus TkNum','NUM',2,'p_num_integer','yacc.py',107),
  ('LIST_INSTRUCTIONS -> INSTRUCTION','LIST_INSTRUCTIONS',1,'p_intruccions_list_base','yacc.py',117),
  ('LIST_INSTRUCTIONS -> LIST_INSTRUCTIONS TkSemicolon INSTRUCTION','LIST_INSTRUCTIONS',3,'p_intruccions_list','yacc.py',123),
  ('INSTRUCTION -> ASIG','INSTRUCTION',1,'p_instruccion','yacc.py',129),
  ('INSTRUCTION -> PRINT','INSTRUCTION',1,'p_instruccion','yacc.py',130),
  ('INSTRUCTION -> FOR_LOOP','INSTRUCTION',1,'p_instruccion','yacc.py',131),
  ('INSTRUCTION -> DO_LOOP','INSTRUCTION',1,'p_instruccion','yacc.py',132),
  ('INSTRUCTION -> CONDITIONAL','INSTRUCTION',1,'p_instruccion','yacc.py',133),
  ('INSTRUCTION -> TkSkip','INSTRUCTION',1,'p_instruccion','yacc.py',134),
  ('ASIG -> TkId TkAsig EXPRESSION','ASIG',3,'p_asig','yacc.py',144),
  ('EXPRESSION -> E','EXPRESSION',1,'p_asig_expresion','yacc.py',150),
  ('EXPRESSION -> ASIG_ARRAY','EXPRESSION',1,'p_asig_expresion','yacc.py',151),
  ('ASIG_ARRAY -> CREATE_ARRAY','ASIG_ARRAY',1,'p_asig_array','yacc.py',157),
  ('ASIG_ARRAY -> WRITE_ARRAY','ASIG_ARRAY',1,'p_asig_array','yacc.py',158),
  ('CREATE_ARRAY -> E TkComma E','CREATE_ARRAY',3,'p_create_array','yacc.py',164),
  ('CREATE_ARRAY -> CREATE_ARRAY TkComma E','CREATE_ARRAY',3,'p_create_array_base','yacc.py',170),
  ('WRITE_ARRAY -> TkId TkOpenPar E TkTwoPoints E TkClosePar','WRITE_ARRAY',6,'p_write_array_base','yacc.py',176),
  ('WRITE_ARRAY -> WRITE_ARRAY TkOpenPar E TkTwoPoints E TkClosePar','WRITE_ARRAY',6,'p_write_array','yacc.py',183),
  ('E -> E TkMult E','E',3,'p_expression_op_binary','yacc.py',190),
  ('E -> E TkPlus E','E',3,'p_expression_op_binary','yacc.py',191),
  ('E -> E TkMinus E','E',3,'p_expression_op_binary','yacc.py',192),
  ('E -> E TkOr E','E',3,'p_expression_op_binary','yacc.py',193),
  ('E -> E TkAnd E','E',3,'p_expression_op_binary','yacc.py',194),
  ('E -> E TkLess E','E',3,'p_expression_op_binary','yacc.py',195),
  ('E -> E TkLeq E','E',3,'p_expression_op_binary','yacc.py',196),
  ('E -> E TkGeq E','E',3,'p_expression_op_binary','yacc.py',197),
  ('E -> E TkGreater E','E',3,'p_expression_op_binary','yacc.py',198),
  ('E -> E TkEqual E','E',3,'p_expression_op_binary','yacc.py',199),
  ('E -> E TkNEqual E','E',3,'p_expression_op_binary','yacc.py',200),
  ('E -> TkOpenPar E TkClosePar','E',3,'p_expression_par','yacc.py',206),
  ('E -> TkNot E','E',2,'p_expression_op_unary','yacc.py',212),
  ('E -> TkMinus E','E',2,'p_expression_op_unary','yacc.py',213),
  ('E -> TkNum','E',1,'p_expression_base','yacc.py',225),
  ('E -> TkId','E',1,'p_expression_base','yacc.py',226),
  ('E -> TkTrue','E',1,'p_expression_base','yacc.py',227),
  ('E -> TkFalse','E',1,'p_expression_base','yacc.py',228),
  ('E -> READ_ARRAY','E',1,'p_expression_base','yacc.py',229),
  ('PRINT -> TkPrint TOPRINT','PRINT',2,'p_print','yacc.py',243),
  ('TOPRINT -> EXPRESSION_TO_PRINT','TOPRINT',1,'p_to_print_base','yacc.py',249),
  ('TOPRINT -> TOPRINT TkConcat EXPRESSION_TO_PRINT','TOPRINT',3,'p_to_print','yacc.py',255),
  ('EXPRESSION_TO_PRINT -> TkId','EXPRESSION_TO_PRINT',1,'p_expression_print','yacc.py',261),
  ('EXPRESSION_TO_PRINT -> STRING','EXPRESSION_TO_PRINT',1,'p_expression_print','yacc.py',262),
  ('EXPRESSION_TO_PRINT -> TkNum','EXPRESSION_TO_PRINT',1,'p_expression_print','yacc.py',263),
  ('EXPRESSION_TO_PRINT -> TkTrue','EXPRESSION_TO_PRINT',1,'p_expression_print','yacc.py',264),
  ('EXPRESSION_TO_PRINT -> TkFalse','EXPRESSION_TO_PRINT',1,'p_expression_print','yacc.py',265),
  ('EXPRESSION_TO_PRINT -> READ_ARRAY','EXPRESSION_TO_PRINT',1,'p_expression_print','yacc.py',266),
  ('STRING -> TkString','STRING',1,'p_string','yacc.py',279),
  ('READ_ARRAY -> ARRAY TkOBracket E TkCBracket','READ_ARRAY',4,'p_array_index','yacc.py',285),
  ('ARRAY -> TkId','ARRAY',1,'p_array_index_id_or_read','yacc.py',291),
  ('ARRAY -> WRITE_ARRAY','ARRAY',1,'p_array_index_id_or_read','yacc.py',292),
  ('FOR_LOOP -> TkFor TkId TkIn E TkTo E TkArrow SUBPROGRAM TkRof','FOR_LOOP',9,'p_for_loop','yacc.py',302),
  ('DO_LOOP -> TkDo GUARD TkOd','DO_LOOP',3,'p_do_loop','yacc.py',309),
  ('CONDITIONAL -> TkIf GUARD TkFi','CONDITIONAL',3,'p_if_conditional','yacc.py',316),
  ('GUARD -> E TkArrow SUBPROGRAM','GUARD',3,'p_guard_base','yacc.py',322),
  ('GUARD -> GUARD TkGuard E TkArrow SUBPROGRAM','GUARD',5,'p_guard','yacc.py',328),
]
